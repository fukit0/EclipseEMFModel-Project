/**
 */
package EMFModel.Graph.provider;
...
/**
 * This is the item provider adapter for a {@link EMFModel.Graph.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphPackage.Literals.EDGE__RELATION,
				 true,
				 false,
				 false,
	...
	protected void addDegreePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_degree_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_degree_feature", "_UI_Edge_type"),
				 GraphPackage.Literals.EDGE__DEGREE,
				 true,
				 false,
				 false,
	...
	public ResourceLocator getResourceLocator() {
		return FamilygraphEditPlugin.INSTANCE;
	}
